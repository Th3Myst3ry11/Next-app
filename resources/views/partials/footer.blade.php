...
<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
      <div class="col-span-full hidden lg:col-span-1 lg:block">
        ...
        <p class="mt-3 text-xs sm:text-sm text-gray-600"></p>
      </div>
      <!-- End Col -->
  
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase">Contact</h4>
  
        <div class="mt-3 grid space-y-3 text-sm">
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Envato <br> level 13, 2 Elizabeth <br>
            Victoria 3000 <br>
            Australia</a></p>
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase">Get our news</h4>
  
        <div class="mt-3 grid space-y-3 text-sm">
            <div class="max-w-sm">
                <input type="email" id="input-label" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Email">
              </div>
      ...
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase">Customer care</h4>
  
        <div class="mt-3 grid space-y-3 text-sm">
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Orders</a></p>
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Downloads</a></p>
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Adresses</a></p>
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Lost password</a></p>
          <p><a class="inline-flex gap-x-2 text-gray-600 hover:text-gray-800" href="#">Log out</a></p>
        </div>
      </div>
      <!-- End Col -->
  
      <div>
        <h4 class="text-xs font-semibold text-gray-900 uppercase">Usefull links</h4>
