...
<div class="bg-white p-6 flex flex-col items-center">
    <h1 class="text-3xl font-bold text-black mb-2">Login</h1>
    <h2 class="text-gray-600 mb-4">Home > myaccount</h2>
</div>
<section class="flex flex-col">
    <div style="margin-left:10%" class="max-w-lg mb-6">
        <label for="input-label-with-helper-text-1" class="block text-sm font-medium mb-2">Username or Email</label>
    ...
    <div style="margin-left: 10%;margin-top:2%" class="flex">
        ...
        <a style="margin-left: 2%;" href="{{ route('signup') }}" class="text-sm font-semibold text-blue-600 underline hover:text-blue-800">
            Sign up for free
        </a>
    </div>
